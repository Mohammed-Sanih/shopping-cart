...
<body style="background-color: #FFE5B4;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #ba8a65; color: white; padding: 5px;">
		<h2>Blossom Beauty</h2>
		<h6>We specialize in Unveiling Beauty</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Blossom Beauty</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=mobile">Skin Care</a></li>
							<li><a href="index.jsp?type=tv">Hair Care</a></li>
							<li><a href="index.jsp?type=laptop">Lip Care</a></li>
							<li><a href="index.jsp?type=camera">Body Care</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
